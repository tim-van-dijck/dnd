<template>
    <div id="proficiency-tab">
        <div uk-accordion="multiple: true;">
            ...
            <tool-selection class="uk-open" :race="race" :subrace="subrace" :classes="characterClasses" v-model="choices.tools" />
            <instrument-selection class="uk-open" :race="race" :subrace="subrace" :classes="characterClasses" v-model="choices.instruments" />
        </div>
