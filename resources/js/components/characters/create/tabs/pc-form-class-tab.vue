        ...
        <div uk-grid>
            ...
            <div class="uk-width-1-3">
                ...
                <div class="uk-grid-small" uk-grid>
                    <div v-for="charClass in availableClasses" class="uk-width-1-4">
                        <button class="uk-button uk-button-default uk-padding-small" :title="charClass.name" @click.prevent="openModal(charClass)">
                            <img style="height: 50px; width: 50px;" :src="`/img/classes/${charClass.name}.svg`">
                        </button>
                        <class-info-modal :selected="charClass" />
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            openModal(selected) {
                UIKit.modal(`#class-info-${selected.name}`).show();
            }
        },
        computed: {
