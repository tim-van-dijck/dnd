        ...
        <div id="quest" v-if="quest" class="uk-container padded">
            <div uk-grid>
                <div class="uk-width-1-2">
                    <h2>Description</h2>
                    <div class="uk-margin">
                        <template v-if="quest.description" v-html="quest.description"/>
                ...
                <div class="uk-width-1-2">
                    ...
                    <div v-if="optional.length > 0" class="uk-card uk-card-body objective"
                         v-for="objective in optional">
                        <span class="actions uk-float-right">
                            <i class="fas fa-check-circle fa-fw" :class="{'uk-text-success': objective.status == 1}"
                               @click.prevent="complete(objective)"></i>
                            <i class="fas fa-times-circle fa-fw" :class="{'uk-text-danger': objective.status == 2}"
...
export default {
    ...
    methods: {
        complete(objective) {
            let url = `/api/campaign/quests/${this.id}/objectives/${objective.id}/toggle`
