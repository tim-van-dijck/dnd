<template>
    <div class="player-classes">
        ...
        <div v-if="Object.keys(availableClasses).length > 0" v-for="(charClass, index) in classes"
            ...
            <div class="uk-card-header">
                ...
                <div class="uk-margin">
                    ...
                    <select :id="`class_${index}`" :name="`class_${index}`" class="uk-select"
                        ...
                        <option v-for="availableClass in classOptions" :value="availableClass.id">{{
                                availableClass.name
                            }}
                        </option>
                    </select>
                ...
                <div class="uk-margin">
                    ...
                    <select :id="`subclass_${index}`" :name="`subclass_${index}`" class="uk-select"
                        ...
                        <option v-for="subclass in subclasses[charClass.class_id]" :value="subclass.id">
                            {{ subclass.name }}
                        </option>
                    </select>
                </div>
